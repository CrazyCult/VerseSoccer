...
export type TacticSituationInput = { minute: number; formationId: number; playStyle: number; scoreCondition: number; goalMargin: number; lineup?: number[] };
